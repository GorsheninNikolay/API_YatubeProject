# Generated by Django 2.2.6 on 2021-07-07 08:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(_negated=True, user=django.db.models.expressions.F('following')), name='block_for_yourself'),
        ),
        migrations.AddConstraint(
            model_name='follow',
